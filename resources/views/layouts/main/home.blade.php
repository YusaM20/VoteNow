                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade" id="penthouse" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <p>Hero Yu Zhong Mobile Legends adalah seorang Hero petarung dengan tiga
                                                wujud.
                                                Yu Zhong memiliki julukan sang Naga Hitam
                                                karena kemampuan ultimate-nya yang memungkinkan Yu Zhong berubah menjadi
                                                naga hitam besar.
                                                Saat berubah menjadi naga hitam besar,
                                                Yu Zhong memiliki kekebalan untuk mengendalikan massa dan kemampuannya
                                ...
                                <div class="tab-pane fade show active" id="appartment" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5">
                                            <h4>Extra Info About Hero</h4>
                                            <p>Ling merupakan salah satu hero Assassin di Mobile Legends yang cukup
                                                populer dan masih
                                                sering digunakan hingga saat ini. Alasan mengapa Ling menjadi populer
                                                adalah karena ia
                                                memiliki kemampuan yang terbilang sempurna untuk Assassin — lincah dan
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <p>Yve merupakan hero Mage yang mampu menghasilkan damage yang sangat besar,
                                                serta bisa menghasilkan crowd control yang sangat mengganggu lawan satu
                                                lane-nya,
                                                Hero Mage seperti Yve memang dibuat unggul ketika team fight tiba karena
                                                selain bisa menghasilkan Magic Damage yang besar,
                                                Real World Manipulation milik Yve juga bisa memberikan pressure terhadap
                                                musuh yang membuat musuh bakal ketakutan saat Yve mengaktifkan
                                                ultimate-nya.
                                            </p>
                                        </div>
                                    </div>
